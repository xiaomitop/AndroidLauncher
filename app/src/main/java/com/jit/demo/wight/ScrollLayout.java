...
public class ScrollLayout extends ViewGroup implements ScrollAdapter.OnDataChangeListener {
    ...
    private void init(Context context) {
        ...
        this.rightPadding = DensityUtil.dip2px(mContext, 5);
        this.leftPadding = DensityUtil.dip2px(mContext, 5);
        this.topPadding = DensityUtil.dip2px(mContext, 5);
        this.bottomPadding = DensityUtil.dip2px(mContext, 5);

        this.colSpace = DensityUtil.dip2px(mContext, 5);
        this.rowSpace = DensityUtil.dip2px(mContext, 5);
    ...
    public void addView(View child, int index, LayoutParams params) {
        ...
        if (pages != totalPage && this.onAddPage != null) {
            if (pages > totalPage) {
...
//					return false;
    ...
    public void showEdit(boolean isEdit) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            iv.setVisibility(isEdit ? View.VISIBLE : View.GONE);
            if (isEdit) {
